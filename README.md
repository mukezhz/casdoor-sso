...
This project uses [Vite](https://vite.dev/) for the frontend and [Express](https://expressjs.com/) for the backend.
...
Runs the frontend app in development mode with Vite on port 9000.

Note that the port is set in `package.json`:

`"start": "vite --host 0.0.0.0 --port 9000"`
